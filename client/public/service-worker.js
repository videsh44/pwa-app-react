...
var offlineFundamentals = [
   ...
   '/',
   '/css/style.css',
   '/static/media/logo.da2e15a6.png',
   'https://mpn.cladev.com/wp-json/ca/v1/getEventList',
   'https://mpn.cladev.com/wp-json/ca/v1/getCategoryList',
   'https://mpn.cladev.com/wp-json/ca/v1/getMobileMentalHealthEventList',
   'https://mpn.cladev.com/wp-json/ca/v1/getPlanList',
   'https://mpn.cladev.com/wp-json/ca/v1/getMentalHealthRoleList',
   'https://mpn.cladev.com/wp-json/ca/v1/getLicenseStateList',
   'https://mpn.cladev.com/wp-json/ca/v1/users',
];
