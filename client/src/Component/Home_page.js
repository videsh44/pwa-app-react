...
export default class Home_page extends Component {
    ...
    async componentDidMount() {
        ...
        axios.get('/ca/v1/getCategoryList').then((res) => {
    ...
    render() {
        ...
        return (
            <div>
                {
                    this.state.route ? <Search_doctor categoryvalue={{ category: this.state.cateval, func: this.removeCategory }} /> : (
                        this.state.isdoctor ? <View_doctor Id={{ index: this.state.docindex, newfunc: this.removetocategory }} /> : <div>
                            ...
                            <div className="header">
                                <div className="container-fluid">
                                    <div className="inner-con">
                                        {
                                            !isIOSDevice() && <div className="hemburger-menu">
                                                <a href="#" id="menuBtn"><img src={hemburger} alt="Hemburger" /></a>
                                            </div>
                                        }
                                        <a href="#" className="applogo"><img src={logo} height="40px" alt="" /></a>
                                        <div className="bell">
                            ...
                            <section className="main-section">
                                <div className="search-form">
                                    <div className="container-fluid">
                                        <h1>Find Your Mental<br />Health Professional</h1>

                                        <div className="form">
                                            <input type="text" className="searchInput" onChange={this.handleChange}
                                                onKeyDown={this.handleKeyDown} value={this.state.search} placeholder="Search Name, City or Zip" />
                                        </div>
                                    </div>
                                </div>
                                <div className="content-section">
                                    <div className="container-fluid">
                                        ...
                                        <div className="category-list">
                                            <ul>
                                                {
                                                    !this.state.loading && categorylist && categorylist.map((val, index) => (
                                                        <li key={index} onClick={() => { this.getCategory(val) }}>
                                                            <figure><img src={val.image_url} alt={val.label} /></figure>
                                        ...
                                        <h2 className="flexbox">Mental Health Professional<a href='#!' onClick={this.removefilter}>Show All</a></h2>
                                        {
                                            this.state.online ? (this.state.loading ? <Loader /> : <div className="expert-category-list">
                                                <ul>
                                                    {
                                                        this.state.total_post != "" ? this.state.total_post.map((val, index) => (
                                                            <li key={index} onClick={() => { this.getDetail(val.user_data.ID) }}>
                                                                <figure>{val.image_url != "" ? <img src={val.image_url} alt={val.category_name} /> : <img src={noimage} alt="any name" />}</figure>
                                                                <div className="caption">
                                                                    <h3>{val.user_other_info.first_name[0]} {val.user_other_info.last_name[0]}<span></span></h3>
                                                                    <h4>
                                                                        {
                                                                    ...
                                                                    <p>{val.user_other_info.user_address[0]}, {val.user_other_info.user_country[0]} {val.user_other_info.user_zip_code[0]}</p>
                                                                </div>
                                                            </li>
                                                        )) : <li className="center">Data not found....</li>
                                                    }
                                                </ul>
                                            </div>) : <div className="center">Data Not Found......</div>
                                        }
                                        {
