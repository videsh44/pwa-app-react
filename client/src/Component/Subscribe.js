...
const Subscribe = (props) => {
  ...
  const [publishableKey, setPublishableKey] = useState("pk_test_51ITfyAGo9T8oxEDGMBQi9Nu2SzojDmIr8LhyNaNfOZsGymTAvgLocAB0wJtR1TxiFcDYDDKRlaRKIudBMYBwXtOA00YPLWv9L4");
